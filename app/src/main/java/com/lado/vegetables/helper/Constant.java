...
public class Constant {
    ...
    public static String FAQ_URL = MAINBASEUrl + "pages_web/faq";
    public static String SliderUrl = BaseUrl + "slider-images";
    public static String CategoryUrl = BaseUrl + "get-categories";
    public static String Get_RazorPay_OrderId = BaseUrl + "create-razorpay-order";
    public static String SubcategoryUrl = BaseUrl + "get-subcategories-by-category-id";
    public static String FeaturedProductUrl = BaseUrl + "sections";
    public static String GET_SECTION_URL = BaseUrl + "sections";
    public static String RegisterUrl = BaseUrl + "user-registration";
    public static String PAPAL_URL = MAINBASEUrl + "paypal/create-payment";
    public static String LoginUrl = BaseUrl + "login";
    public static String OFFER_URL = BaseUrl + "offer-images";
    public static String PRODUCT_SEARCH_URL = BaseUrl + "products-search";
    public static String SETTING_URL = BaseUrl + "settings";
    public static String GET_PRODUCT_BY_SUB_CATE = BaseUrl + "get-products-by-subcategory-id";
    public static String GET_PRODUCT_DETAIL_URL = BaseUrl + "get-product-by-id";
    public static String CITY_URL = BaseUrl + "get-cities";
    public static String GET_AREA_BY_CITY = BaseUrl + "get-areas-by-city-id";
    public static String ORDERPROCESS_URL = BaseUrl + "order-process";
    public static String USER_DATA_URL = BaseUrl + "get-user-data";

    public static String PROMO_CODE_CHECK_URL = BaseUrl + "validate-promo-code";
    ...
    public static String JWT_KEY = "qwertzxcvb";
