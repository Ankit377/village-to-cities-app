    ...
    public void OnBtnClick(View view) {
        switch (view.getId()) {
            case R.id.tvConfirmOrder:
                ...
                tvDelivery.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.light_colorPrimary));
                            ...
                            if (result) {
                                try {
                                    ...
                                    if (!object.getBoolean(Constant.ERROR)) {
                                        ...
                                        btnApply.setBackgroundColor(ContextCompat.getColor(getApplicationContext(), R.color.light_colorPrimary));
